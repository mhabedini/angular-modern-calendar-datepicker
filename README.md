...
```bash
git clone https://github.com/mhabedini/angular-modern-calendar-datepicker.git
cd angular-modern-calendar-datepicker
```
...
Run `ng build angular-modern-calendar-datepicker` to build the library specifically.
